      ...
      <header className="flex flex-col items-center">
        <div className="flex flex-col items-center px-2 md:w-1/2 mt-32">
          ...
          <p className="text-center">
            Bootcamps are a great investment to transform your future. We
            partner with the best schools to offer tuition and cost of living
            loans to help you take control of your career -{" "}
      ...
      <section className="flex flex-col md:flex-row md:justify-around md:items-center ">
        <div className="md:w-1/3 p-4">
          <h2 className="font-normal md:text-4xl">
            Wondering How To Pay For A Bootcamp?
          </h2>
          <p>
            Bootcamps are a life-changing investment in your future & the career
            you've been dreaming of. We make the dream attainable by helping you
            finance your education. Skills Fund provides the help you deserve to
            build the career you want with simple, straightforward bootcamp
            loans.
          </p>
        </div>
